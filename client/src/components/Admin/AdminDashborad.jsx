...
function ResponsiveDrawer(props) {
    ...
    useEffect(() => {
        axios.get('http://localhost:8000/api/v1/user/donars_receivers').then((res) => {
        ...
        <Box sx={{ flexGrow: 1, padding: 2 }}>
            <Grid container spacing={2}>
                <Grid item xs={12} md={6}>
                    <Card sx={{ borderRadius: 2, height: 348,background:lightBlue[100] ,boxShadow: "rgba(0, 0, 0, 0.24) 0px 3px 8px"}}>
                        <Typography variant='h6' sx={{ padding: 2,fontWeight:700 }}>Analytics</Typography>
                        {graphsLoading ? <Box textAlign={"center"}><CircularProgress /></Box> : (
                            <Box>
                                {
                ...
                <Grid item xs={12} md={6}>
                    <Grid container rowSpacing={2} columnSpacing={2}>
                        ...
                        <Grid item xs={12} md={6}>
                            <Card sx={{ backgroundColor: blue[100], height: 165, borderRadius: 3, padding: 2,boxShadow: "rgba(0, 0, 0, 0.24) 0px 3px 8px" }}>
                                ...
                                <Typography variant='h5' sx={{
                                    color: indigo[500],
                                    fontWeight: 'bold'
                                }}>{graphsLoading ? <CircularProgress /> : donarsAvailable}</Typography>
                            </Card>
                        </Grid>
                        <Grid item xs={12} md={6}>
                            <Card sx={{ backgroundColor: pink[100], height: 165, borderRadius: 3, padding: 2,boxShadow: "rgba(0, 0, 0, 0.24) 0px 3px 8px"}}>
                                <Typography align='left' variant='h6' sx={{
                                    color: pink[500],
                                    fontWeight: 'bold'
                                }}>
                                ...
                                <Typography variant='h5' sx={{
                                    color: pink[500],
                                    fontWeight: 'bold'
                                }}>{graphsLoading ? <CircularProgress /> : donarsPending}</Typography>
                            </Card>
                        </Grid>
                        <Grid item xs={12} md={6}>
                            <Card sx={{ backgroundColor: orange[200], height: 165, borderRadius: 3, padding: 2,boxShadow: "rgba(0, 0, 0, 0.24) 0px 3px 8px" }}>
                                <Typography align='left' variant='h6' sx={{
                                    color: orange[500],
                                    fontWeight: 'bold'
                                }}>
                                ...
                                <Typography variant='h5' sx={{
                                    color: orange[500],
                                    fontWeight: 'bold'
                                }}>{graphsLoading ? <CircularProgress /> : bloodRequests}</Typography>
                            </Card>
                        </Grid>
                        <Grid item xs={12} md={6}>
                            <Card sx={{ backgroundColor: purple[200], height: 165, borderRadius: 3, padding: 2,boxShadow: "rgba(0, 0, 0, 0.24) 0px 3px 8px"}}>
                                <Typography align='left' variant='h6' sx={{
                                    color: purple[500],
                                    fontWeight: 'bold'
                                }}>
                                ...
                                <Typography variant='h5' sx={{
                                    color: purple[500],
                                    fontWeight: 'bold'
                                }}>{graphsLoading ? <CircularProgress /> : bloodRequestsApproved}</Typography>
                            </Card>
                        </Grid>
                        {/* </Box> */}
                    </Grid>
                                    ...
                                    <Card sx={{ display: 'flex', alignItems: "center", justifyContent: 'space-between', padding: 1, mt: 2, borderRadius: 2, background: '#fff' }}>
                                        <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                            ...
                                            <CardContent>
                                                ...
                                                <Typography variant='subtitle2' sx={{color:item.status === "Pending" ? yellow[700] : green[400]}}>{`(${item.status})`}</Typography>                                                
                                            </CardContent>
                                        </Box>
                                        <Box sx={{
                                            padding: 1,
                    ...
                    <Card sx={{boxShadow: "rgba(0, 0, 0, 0.24) 0px 3px 8px"}}>
                        <CardContent>
                            <Typography variant='h6' sx={{
                                fontWeight: '700',
                                mt:1
                            }}>Recent Blood Requests</Typography>
                            <Input
                            ...
                            {filteredReceiversData.length > 0 && filteredReceiversData
                                .slice(0, showMore)
                                ?.map((item) => (
                                    <Card sx={{ display: 'flex', alignItems: "center", justifyContent: 'space-between', padding: 1, mt: 2, borderRadius: 2, background: '#fff' }}>
                                        <Box sx={{ display: 'flex', alignItems: 'center' }}>
                            ...
                            {showMoreRec < filteredData.length && <Box
                                sx={{
                                    padding: 2,
                                    color: indigo[300],
                                    textAlign: 'center',
